    ...
    <div class="container" style="margin-top:50px; margin-bottom:60px;">
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <form method="POST" action="car" class="needs-validation" novalidate>
                @csrf
                <div class="row">
                    <div class="col-6">
                    <div class="form-group">
                        <label for="name">Car Name</label>
                        <input type="text" pattern="^[A-z]{3,}$" class="form-control" id="car_name" name="car_name" placeholder="Enter car name" required>
                        <div class="invalid-feedback">
                            Please choose a valid carname.
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="seater">Plate No.</label>
                        <input type="number" min="1000" max="9999" class="form-control" id="plate_no" name="plate_no" placeholder="Enter plate number" required>
                        <div class="invalid-feedback">
